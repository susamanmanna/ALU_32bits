...
And ,for shifting by left and right  range upto 0 to 31 bits ,and for that I used barrel shifter that gives shifting result with time of O(1) , givinng massive performance benefits upto max 90 % . 
and ,or ,xor that used just simple bitwise operation .
